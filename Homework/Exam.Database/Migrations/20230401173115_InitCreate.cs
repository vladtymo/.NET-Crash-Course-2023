        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GroupFK = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_Students_StudentFK",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lecturers_Subjects_SubjectFK",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lecturers_SubjectFK",
                table: "Lecturers",
                column: "SubjectFK",
                unique: true,
                filter: "[SubjectFK] IS NOT NULL");
