...
namespace Tasks_4
{
	class Program
	{
		...
		static void Task3(string line)
		{
			...
			double upperPercent = (double)upperCount / totalChars * 100;
			double lowerPercent = (double)lowerCount / totalChars * 100;
			Console.WriteLine("Upper case percentage: {0}%", upperPercent);
			Console.WriteLine("Lower case percentage: {0}%", lowerPercent);
